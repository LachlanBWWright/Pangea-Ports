...
void test_lua_integration(void)
{
	...
	const char* test_script =
		...
		"local nativeHandle = nil\n"
		"local scriptedHandle = nil\n"
		"local module = {}\n"
		"\n"
		...
		"  end\n"
		"  if scriptedHandle then\n"
		"    local pos = pangea.object.position(scriptedHandle)\n"
	...
	write_temp_file("Data/Scripts/dist/main.lua", test_script);
...
{
	printf("==================================================\n");
	printf(" Running Real Lua Backend Integration Tests       \n");
	printf("==================================================\n");
