...
typedef struct PangeaScriptPlayerSnapshot
{
	...
	bool hasWeaponState;
	float weaponCharge;
	bool hasWeaponChargeState;
	bool giant;
	float giantTimeRemaining;
	bool hasGiantState;
	int weaponCount;
	...
	bool hasShieldTimerState;
	bool invulnerable;
	bool hasInvulnerabilityState;
	bool dead;
	bool hasDeathState;
	float invulnerabilityTimeRemaining;
	bool hasInvulnerabilityTimerState;
	bool knockedDown;
	float knockdownTimeRemaining;
	bool hasKnockdownState;
	bool burning;
	float burnTimeRemaining;
	bool hasBurnState;
	PangeaScriptPlayerForm form;
	bool hasForm;
	float formTimeRemaining;
	bool hasFormTimerState;
	int miceRescued;
	bool hasMiceState;
	int miceTotal;
	...
	bool hasGroundPhysicsState;
	bool hasGroundSteeringState;
	bool nitroActive;
	float nitroTimeRemaining;
	bool greasedTiresActive;
	float greasedTiresTimeRemaining;
	bool stickyTiresActive;
	float stickyTiresTimeRemaining;
	bool superSuspensionActive;
	float superSuspensionTimeRemaining;
	bool invisibilityActive;
	float invisibilityTimeRemaining;
	bool frozen;
	float frozenTimeRemaining;
	bool flaming;
	float flamingTimeRemaining;
	bool submarineImmobilized;
	float submarineImmobilizedTimeRemaining;
	bool ramming;
	float rammingTimeRemaining;
	bool hasRammingState;
	bool planing;
	bool hasVehicleModifierState;
	int team;
	bool hasTeamState;
	bool carryingFlag;
	int captureScore;
	...
	bool levelComplete;
	bool hasLevelCompletionState;
	PangeaScriptVector3 camera;
	bool hasCameraState;
	bool ridingBall;
	bool hasRidingBallState;
	float tunnelSpeed;
	float tunnelAngle;
	float tunnelBanking;
	bool hasTunnelState;
	...
	bool hasGlideState;
	bool grounded;
	bool hasGroundedState;
	float heightOffGround;
	bool hasTerrainHeightState;
	bool onWater;
	bool hasWaterState;
	bool onLava;
	bool hasLavaState;
	bool jetpackActive;
	bool hasJetpackState;
	int animation;
	bool hasAnimationState;
	float animationSpeed;
	bool hasAnimationSpeedState;
	int animationFrame;
	bool hasAnimationFrameState;
	bool active;
...
typedef struct PangeaScriptLevelContext
{
	...
	float modeTimer;
	bool hasModeState;
	int modeSequenceIndex;
	int modeSequenceLength;
	int modeEnemyCount;
	int modeReflex;
	bool modeCanAdvance;
	bool hasModeDetails;
...
typedef struct PangeaScriptObjectOps
{
	...
	bool (*getAnimationSpeed)(void* nativeObject, float* outSpeed);
	bool (*getAnimationFrame)(void* nativeObject, int* outFrame);
	bool (*getActive)(void* nativeObject, bool* outActive);
	bool (*getHealth)(void* nativeObject, float* outHealth);
	bool (*getDamage)(void* nativeObject, float* outDamage);
