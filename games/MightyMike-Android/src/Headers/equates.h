...
#define		MODEL_GROUP_SCENE_BANK_BASE	10
#define		MODEL_GROUP_SCENE_BANK_COUNT	(MAX_SCENES * 2)
#define		MAX_SHAPE_GROUPS	(MODEL_GROUP_SCENE_BANK_BASE + MODEL_GROUP_SCENE_BANK_COUNT)
