...
extern	int						GetDefaultBiomeForLevel(short levelNum);
extern	void						ReadLevelMetadata(void);
extern	void						LoadLevelMetadata(void);
extern	int						LevelMetadataMapViewFor(const char *key, int fallback);
