...
enum
{
	...
	MODEL_GROUP_SCRIPT_CUSTOM_BASE = 6,
	MODEL_GROUP_SCRIPT_CUSTOM_COUNT = 4,
	MODEL_GROUP_ILLEGAL		= 0xFF,
};

#define MODEL_GROUP_LEVEL_BANK_BASE (MODEL_GROUP_SCRIPT_CUSTOM_BASE + MODEL_GROUP_SCRIPT_CUSTOM_COUNT)
#define MODEL_GROUP_LEVEL_BANK_COUNT 12
#define MAX_3DMF_GROUPS (MODEL_GROUP_LEVEL_BANK_BASE + MODEL_GROUP_LEVEL_BANK_COUNT)
